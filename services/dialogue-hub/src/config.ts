...
export const REDIS_URI = process.env.REDIS_URI || (process.env.REDIS_HOST ? `redis://${process.env.REDIS_HOST}:${process.env.REDIS_PORT || '6379'}` : false) || 'redis://localhost:6379'
